...
import audiosenal_epy_block_0 as epy_block_0  # embedded python block
import numpy as np
import sip
import threading
...
class audiosenal(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("gnuradio/flowgraphs", "audiosenal")
        ...
        self.blocks_file_source_0 = blocks.file_source(gr.sizeof_char*1, 'C:\\Users\\User\\Downloads\\2026-1\\comunicaciones\\laboratorio\\Practica2\\sonido.wav', True, 0, 0)
...
def main(top_block_cls=audiosenal, options=None):
