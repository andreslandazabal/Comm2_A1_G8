...
class MPSK(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.constelation = constelation = (1+0j , 0+1j, -1+0j, 0-1j)
        self.MPSK_con = MPSK_con = (1+0j, 0.77+0.77j, 0+1j, -0.77+0.77j, -1+0j, -0.77-0.77j, 0-1j, 0.77-0.77j)
        ...
        labels = ['Int_EC_Real', 'Int_EC_Imag', 'Signal 3', 'Signal 4', 'Signal 5',
        ...
        self.digital_chunks_to_symbols_xx_0_0 = digital.chunks_to_symbols_bc(MPSK_con, 1)
        ...
        self.connect((self.blocks_throttle2_0, 0), (self.qtgui_const_sink_x_0_0_0, 0))
    ...
    def get_MPSK_con(self):
        return self.MPSK_con

    def set_MPSK_con(self, MPSK_con):
        self.MPSK_con = MPSK_con
        self.digital_chunks_to_symbols_xx_0_0.set_symbol_table(self.MPSK_con)
