...
import practica_epy_block_0 as epy_block_0  # embedded python block
import sip
import threading



class practica(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("gnuradio/flowgraphs", "practica")
...
def main(top_block_cls=practica, options=None):
